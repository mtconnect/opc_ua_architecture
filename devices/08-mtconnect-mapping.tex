...
The MTConnect \gls{MTDataItem} represents multiple OPC UA \uamodel{DataVariableType}s as described in parts \cite{UAPart8}. The mapping rules MUST be applied in strict sequence as follows:
