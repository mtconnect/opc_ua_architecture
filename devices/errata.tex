...
\begin{mdframed}[innerleftmargin=0pt,innerrightmargin=0pt,%
  ...
  \begin{tabu} to 5.75in {X[0.6] X X[0.3] X[1.1]}
    ...
    Title: & {\getdoctitleshort \newline \getdoctitlepart \space \getdoctitlesubpart} & Date: & \today \\  \tabucline[1pt]{2-2} \tabucline[1pt]{4-4}
    Version: & \getversiontext\ \getversionnum & Software: & LaTeX  \\ \tabucline[1pt]{2-2} \tabucline[1pt]{4-4}
    Authors: & William Sobel, Randy Armstrong, John Turner, Russell Waddell, Shaurabh Singh & Source: & OPC\_UA\_MTConnect\_Errata\_\getversionnum.pdf \\  \tabucline[1pt]{2-2} \tabucline[1pt]{4-4}
