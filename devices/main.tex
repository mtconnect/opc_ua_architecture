...
\input{converted/061-mtconnect.md.tex}

\input{converted/062-opc-ua.md.tex}

\input{converted/07-use-cases.md.tex}

\input{converted/08-mtconnect-mapping.md.tex}
...
\input{./converted/09-types.md.tex}

\clearpage

\input{converted/10-profiles-and-namespaces.md.tex}
