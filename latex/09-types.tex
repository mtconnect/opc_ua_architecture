% Generated 2019-05-04 21:28:32 -0700
...
\begin{itemize}
\item Dependency on MTCategoryType

This class relates to \texttt{MTCategoryType} (See section \ref{type:MTCategoryType}) for a(n) \texttt{} relationship.

\item Dependency on MTRepresentationType

This class relates to \texttt{MTRepresentationType} (See section \ref{type:MTRepresentationType}) for a(n) \texttt{} relationship.
...
\begin{itemize}
\item \texttt{Supertype::AnalogUnitType:} \item \texttt{Supertype::AnalogUnitType:} All DataItems with category SAMPLE
