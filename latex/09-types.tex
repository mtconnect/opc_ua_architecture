% Generated 2019-05-21 13:14:18 -0700
...
\begin{itemize}
  \item \texttt{getStatusCode()}\newline    Documentation: When the \mtmodel{ResetTrigger} is set because a statistic has been reset and the duration is present, the \uamodel{StatusCode} will have the \uamodel{SemanticsChanged} bit set (14:14) of the status code as defined in \cite{UAPart4}.

When this bit is set, the client should refer to the ResetTriggered property to ascertain the reason for the bit being set.
