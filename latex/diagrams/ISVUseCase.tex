...
\centering\scalebox{0.8}{\begin{tikzpicture}[node distance = 2cm, auto]
    ...
    \node [blockyellow, right of=opcuaserver, node distance = 3.4 cm] (opcuaclient2) {\small{OPC UA Client}};
    \node [blockblue, above of=opcuaserver, node distance = 2.1cm] (mtcagent) {\small{MTConnect Agent}};
    \node [blockblue, above of=opcuaclient2, node distance = 2.1 cm, fill = blue!30] (mtcagent2) {\small{MTConnect Agent}};
    ...
    \node [blockyellow, below right of=opcuaclient2, node distance = 4 cm, minimum height = 2.5em, fill = yellow!10, yshift =-2em] (device3) {Device};
    ...
    \path [line] (device3) -- (c) -| (opcuaclient2);
    \path [line] (device4) -- (c) -| (opcuaclient2);
    \path [line] (opcuaclient2) |- (c) -- (device3);
    \path [line] (opcuaclient2) |- (c) -- (device4);
