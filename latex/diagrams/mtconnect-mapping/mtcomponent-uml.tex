...
\umlabstract[below right = 2.5cm and 2cm of MTComponentType]{MTCompositionType}{
+ Uuid: String[0..1] \\
+ Name: String[0..1] \\
+ MTDescription: String[0..1] \\
}

\umluniassoc[geometry=-|-, stereo=Organizes, pos stereo=1.6, pos1=1.4,pos2=1.2, arg1=Composition, anchor1=-40, mult1=1..*] {MTComponentType} {MTCompositionType}

\umlsimpleclass[below=2cm of MTCompositionType]{<Composition>Type}{}
\umlinherit[geometry=--, stereo = bind]{<Composition>Type}{MTCompositionType}
...
\umluniassoc[geometry=--, stereo=Organizes, arg1=Channels, mult1=0..*, mult2=1..*] {MTSensorConfigurationType} {MTChannelType}
