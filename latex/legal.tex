...
\textbf{\Large {OPC Foundation and \mtconnect Institute}}

\begin{center}
    \textbf{AGREEMENT OF USE \\ 
    ({\color{red} SUBJECT TO FINAL REVIEW BY \\ 
    MTConnnect and OPC Foundation Legal Teams})}
\end{center}
...
Copyright\textsuperscript{\copyright} 2018, MTConnect Institute
...
This Agreement shall be governed by and construed under the laws of the State of Virginia, excluding its choice or law rules.
