...
{\color{red} The alternative architecture is to have the message as an \gls{Event} subtype, but the dual instantiation of the \mtuatype{MTMessageType} as an \gls{Object} and an \gls{Event} proved to be very complicated to implement. This can be reconsidered.}
