  ...
  \begin{itemize}
    ...
    \begin{enumerate}
      ...
      \begin{enumerate}
        ...
        \item Convert the \gls{type} attribute to \gls{PascalCase} and append \mtmodel{ClassType}. This name will be referred to as \textit{\mtmodel{@classType}}.
        
        \item Find the MTConnect UA \textit{\mtmodel{@classType}} that corresponds to the value computed in the previous step.
        ...
        \item If the \textit{\mtmodel{@classType}} matches one of the \mtuamodel{StringEventDataItemTypes}; the MTConnect UA \gls{TypeDefinition} is \mtuatype{MTStringEventType}.
        
        \item If the \textit{\mtmodel{@classType}} matches one of the \mtuamodel{NumericEventDataItemTypes}; the MTConnect UA \gls{TypeDefinition}  is \mtuatype{MTNumericEventType}.
        
        \item If the \textit{\mtmodel{@classType}} matches one of the  \mtuamodel{ControlledVocabDataItemTypes}, the MTConnect UA \gls{TypeDefinition} is \mtuatype{MTControlledVocabEventType}. The \uamodel{EnumValues} will be assigned as follows:
        \newline
        
        Each of the \glspl{ObjectType} matching the \textit{\mtmodel{@classType}} for \mtuamodel{ControlledVocabDataItemTypes} will have a \gls{Property} \uamodel{EnumValues}. The \uamodel{EnumValues} will reference the \uamodel{Enumeration} with the values of the \gls{ControlledVocab}.
