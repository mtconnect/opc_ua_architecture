...
MTConnect \texttt{subType} will be mapped in the same manner as the type using the \mtuatype{HasMTSub\-Class\-Type} relationship. This will be covered subsequent examples.
