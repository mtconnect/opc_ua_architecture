...
Nodes of all other \glspl{NodeClass} cannot be defined in the same table; therefore only the used \opcuaterm{ReferenceType}, their \opcuaterm{NodeClass} and their \opcuaterm{BrowseName} are specified. A reference to another part of this document points to their definition.
