...
The MTConnect Data Item with Category of \mtmodel{CONDITION} are mapped to the OPC UA \glspl{ConditionType}  in \cite{UAPart9} with a \uamodel{TwoStateVariableType} that represents the current state of all the active \uaterm{branches} of this \mtmodel{Condition}.
