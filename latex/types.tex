% Generated 2018-10-11 13:10:02 -0700
...
NonHierarchialReferenceType & Variable & <Dynamic> &  BaseObjectType & <Dynamic> & Optional \\
Organizes & Object & Conditions &  AlarmConditionType & FolderType & Optional \\
HasProperty & Variable & <Dynamic> &  MTEnumeratedEventType & PropertyType & Mandatory \\
HasProperty & Variable & <Dynamic> &  MTNumericEventType & PropertyType & Mandatory \\
HasProperty & Variable & <Dynamic> &  MTStringEventType & PropertyType & Mandatory \\
...
\FloatBarrier
\subsection{Sample Data Item Types}
...
\FloatBarrier
\subsection{Controlled Vocab Data Item Types}
...
\tabucline[1.5pt]{}
\rowfont \bfseries References & NodeClass & BrowseName & DataType & TypeDefinition & {Modeling Rule} \\
\multicolumn{6}{|l|}{Subtype of MTEventClassType (See Data Item Types Documentation)} \\
...
\FloatBarrier
\subsection{Numeric Event Data Item Types}
...
\FloatBarrier
\subsection{String Event Data Item Types}
...
\tabucline[1.5pt]{}
\rowfont \bfseries References & NodeClass & BrowseName & DataType & TypeDefinition & {Modeling Rule} \\
\multicolumn{6}{|l|}{Subtype of MTDataItemClassSubType (See section \ref{type:MTDataItemClassSubType})} \\
\end{tabu}
\end{table} 
