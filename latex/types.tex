% Generated 2018-10-16 15:11:50 -0700
...
HasProperty & Object & Number &  Int32 & PropertyType & Optional \\
HasProperty & Object & Name &  String & PropertyType & Optional \\
HasProperty & Object & MTDescription &  String & PropertyType & Optional \\
HasProperty & Object & CalibrationDate &  UtcTime & PropertyType & Optional \\
HasProperty & Object & NextCalibrationDate &  UtcTime & PropertyType & Optional \\
HasProperty & Object & CalibrationInitials &  String & PropertyType & Optional \\
\end{tabu}
\end{table} 
...
\rowfont \bfseries References & NodeClass & BrowseName & DataType & TypeDefinition & {Modeling Rule} \\
\multicolumn{6}{|l|}{Subtype of \texttt{BaseObjectType} (See OPC UA Part 5 Documentation)} \\
HasProperty & Object & Station &  String & PropertyType & Optional \\
HasProperty & Object & SerialNumber &  String & PropertyType & Optional \\
HasProperty & Object & Manufacturer &  String & PropertyType & Optional \\
HasProperty & Object & Data &  String & PropertyType & Optional \\
\end{tabu}
\end{table} 
...
HasProperty & Object & XmlId &  String & PropertyType & Optional \\
HasProperty & Object & Name &  String & PropertyType & Optional \\
HasProperty & Object & NativeName &  String & PropertyType & Optional \\
HasProperty & Object & Uuid &  String & PropertyType & Optional \\
HasProperty & Object & SampleRate &  Float & PropertyType & Optional \\
HasProperty & Object & SampleInterval &  Float & PropertyType & Optional \\
HasComponent & Object & Description &  DescriptionType & DescriptionType & Optional \\
HasComponent & Object & Configuration &  MTConfigurationType & MTConfigurationType & Optional \\
HasMTReferenceType & Object &  &  BaseObjectType & BaseObjectType & Optional \\
HasComponent & Variable &  &  MTEnumeratedEventType & MTEnumeratedEventType & Optional \\
HasComponent & Variable &  &  MTNumericEventType & MTNumericEventType & Optional \\
HasComponent & Variable &  &  MTStringEventType & MTStringEventType & Optional \\
HasComponent & Variable &  &  MTSampleType & MTSampleType & Optional \\
HasComponent & Event &  &  MTMessageType & MTMessageType & Optional \\
HasComponent & Variable &  &  AssetEventType & AssetEventType & Optional \\
Organizes & Object & Components &  FolderType & FolderType & Optional \\
Organizes & Object & Compositions &  FolderType & FolderType & Optional \\
Organizes & Object & Conditions &  FolderType & FolderType & Optional \\
\end{tabu}
\end{table} 
...
HasProperty & Object & Version &  String & PropertyType & Optional \\
HasProperty & Object & Iso841Class &  String & PropertyType & Optional \\
\end{tabu}
\end{table} 
...
HasProperty & Object & FirwareVersion &  String & PropertyType & Optional \\
HasProperty & Object & CalibrationDate &  UtcTime & PropertyType & Optional \\
HasProperty & Object & NextCalibrationDate &  UtcTime & PropertyType & Optional \\
HasProperty & Object & CalibrationInitials &  String & PropertyType & Optional \\
HasChannels & Object & Channels &  ChannelType & ChannelType & Optional \\
\end{tabu}
\end{table} 
...
DataType & \multicolumn{5}{|l|}{UMLAssociation} \\
\tabucline[1.5pt]{}
\rowfont \bfseries References & NodeClass & BrowseName & DataType & TypeDefinition & {Modeling Rule} \\
...
HasProperty & Object & MTClassName &  String & PropertyType & Optional \\
HasProperty & Object & MTSubTypeName &  String & PropertyType & Optional \\
HasProperty & Object & SourceName &  String & PropertyType & Optional \\
HasProperty & Object & StreamRate &  Double & PropertyType & Optional \\
HasProperty & Object & SampleRate &  Double & PropertyType & Optional \\
HasProperty & Object & Representation &  MTRepresentationType & PropertyType & Optional \\
HasMTClassType & Object &  &  MTDataItemClassType & MTDataItemClassType & Optional \\
HasMTSubClassType & Object &  &  MTDataItemSubClassType & MTDataItemSubClassType & Optional \\
HasComponent & Object & MinimumDeltaFilter &  MinimumDeltaFilterType & MinimumDeltaFilterType & Optional \\
HasComponent & Object & PeriodDelta &  PeriodFilterType & PeriodFilterType & Optional \\
HasMTComposition & Object &  &  MTCompositionType & MTCompositionType & Optional \\
Attribute Override & Object & DataType &  AssetEventDataType & AssetEventDataType & Optional \\
\end{tabu}
\end{table} 
...
HasProperty & Object & SignificantDigits &  UInt16 & PropertyType & Optional \\
HasProperty & Object & Statistic &  String & PropertyType & Optional \\
HasProperty & Object & Units &  String & PropertyType & Optional \\
HasProperty & Object & NativeUnits &  String & PropertyType & Optional \\
HasProperty & Object & CoordinateSystem &  CoordinateSystemType & PropertyType & Optional \\
HasProperty & Object & InitialValue &  Double & PropertyType & Optional \\
HasProperty & Object & ResetTrigger &  DataItemResetValueType & PropertyType & Optional \\
HasProperty & Object & Nominal &  Double & PropertyType & Optional \\
\end{tabu}
\end{table} 
...
IsAbstract & \multicolumn{5}{|l|}{False} \\
ValueRank & \multicolumn{5}{|l|}{-1} \\
DataType & \multicolumn{5}{|l|}{UMLAttribute} \\
\tabucline[1.5pt]{}
\rowfont \bfseries References & NodeClass & BrowseName & DataType & TypeDefinition & {Modeling Rule} \\
...
HasProperty & Object & Value &  Float & PropertyType & Optional \\
\end{tabu}
\end{table} 
...
HasProperty & Object & NativeCode &  String & PropertyType & Optional \\
\end{tabu}
\end{table} 
...
HasProperty & Object & ResetTrigger &  DataItemResetValueType & PropertyType & Optional \\
HasProperty & Object & Nominal &  Double & PropertyType & Optional \\
HasProperty & Object & EURange &  Range & PropertyType & Optional \\
HasProperty & Object & EngineeringUnits &  EUInformation & PropertyType & Optional \\
\end{tabu}
\end{table} 
...
\paragraph{Dependency on ActiveStateDataType}

This class relates to \texttt{ActiveStateDataType} (See section \ref{type:ActiveStateDataType}) for a(n) \texttt{values} relationship.
...
\paragraph{Dependency on AvailabilityDataType}

This class relates to \texttt{AvailabilityDataType} (See section \ref{type:AvailabilityDataType}) for a(n) \texttt{values} relationship.
...
\paragraph{Dependency on AxisCouplingDataType}

This class relates to \texttt{AxisCouplingDataType} (See section \ref{type:AxisCouplingDataType}) for a(n) \texttt{values} relationship.
...
\paragraph{Dependency on AxisStateDataType}

This class relates to \texttt{AxisStateDataType} (See section \ref{type:AxisStateDataType}) for a(n) \texttt{values} relationship.
...
\paragraph{Dependency on OpenStateDataType}

This class relates to \texttt{OpenStateDataType} (See section \ref{type:OpenStateDataType}) for a(n) \texttt{values} relationship.
...
\paragraph{Dependency on ControllerModeDataType}

This class relates to \texttt{ControllerModeDataType} (See section \ref{type:ControllerModeDataType}) for a(n) \texttt{values} relationship.
...
\paragraph{Dependency on ExecutionDataType}

This class relates to \texttt{ExecutionDataType} (See section \ref{type:ExecutionDataType}) for a(n) \texttt{values} relationship.
...
\paragraph{Dependency on CompositionStateDataType}

This class relates to \texttt{CompositionStateDataType} (See section \ref{type:CompositionStateDataType}) for a(n) \texttt{values} relationship.
...
\paragraph{Dependency on OnOffDataType}

This class relates to \texttt{OnOffDataType} (See section \ref{type:OnOffDataType}) for a(n) \texttt{values} relationship.
...
\paragraph{Dependency on DirectionDataType}

This class relates to \texttt{DirectionDataType} (See section \ref{type:DirectionDataType}) for a(n) \texttt{values} relationship.
...
\paragraph{Dependency on EmergencyStopDataType}

This class relates to \texttt{EmergencyStopDataType} (See section \ref{type:EmergencyStopDataType}) for a(n) \texttt{values} relationship.
...
\paragraph{Dependency on YesNoDataType}

This class relates to \texttt{YesNoDataType} (See section \ref{type:YesNoDataType}) for a(n) \texttt{values} relationship.
...
\paragraph{Dependency on FunctionalModeDataType}

This class relates to \texttt{FunctionalModeDataType} (See section \ref{type:FunctionalModeDataType}) for a(n) \texttt{values} relationship.
...
\paragraph{Dependency on PathModeDataType}

This class relates to \texttt{PathModeDataType} (See section \ref{type:PathModeDataType}) for a(n) \texttt{values} relationship.
...
\paragraph{Dependency on ProgramEditDataType}

This class relates to \texttt{ProgramEditDataType} (See section \ref{type:ProgramEditDataType}) for a(n) \texttt{values} relationship.
...
\paragraph{Dependency on RotaryModeDataType}

This class relates to \texttt{RotaryModeDataType} (See section \ref{type:RotaryModeDataType}) for a(n) \texttt{values} relationship.
