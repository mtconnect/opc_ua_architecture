% Generated 2019-01-22 10:06:56 -0800
...
Has\-Component & Variable & <MT\-Message> & Message\-Event\-Data\-Type[] & MT\-Message\-Type & Optional \\
...
IsAbstract & \multicolumn{5}{|l|}{False} \\
ValueRank & \multicolumn{5}{|l|}{-1} \\
DataType & \multicolumn{5}{|l|}{MessageEventDataType} \\
\tabucline[1.5pt]{}
\rowfont \bfseries References & NodeClass & BrowseName & DataType & Type\-Definition & {Modeling\-Rule} \\
\multicolumn{6}{|l|}{Subtype of BaseDataVariableType (See \cite{UAPart8} Documentation)} \\
Has\-Property & Variable & Xml\-Id & String & Property\-Type & Mandatory \\
...
\end{itemize}
\FloatBarrier
\subsubsection{Defintion of \texttt{ MessageEventDataType}}
  \label{type:MessageEventDataType}

\FloatBarrier
\begin{table}[ht]
\centering 
  \caption{\texttt{MessageEventDataType} DataType}
  \label{data-type:MessageEventDataType}
\tabulinesep=3pt
\begin{tabu} to 6in {|l|l|l|} \everyrow{\hline}
\hline
\rowfont\bfseries {Field} & {Type} & {Optional} \\
