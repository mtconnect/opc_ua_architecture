% Generated 2018-11-03 20:18:28 -0700
...
HasSubtype & ObjectType & ControllerType & \multicolumn{3}{|l|}{See section \ref{type:ControllerType}} \\
HasSubtype & ObjectType & AxesType & \multicolumn{3}{|l|}{See section \ref{type:AxesType}} \\
HasSubtype & ObjectType & RotaryType & \multicolumn{3}{|l|}{See section \ref{type:RotaryType}} \\
HasSubtype & ObjectType & PathType & \multicolumn{3}{|l|}{See section \ref{type:PathType}} \\
HasSubtype & ObjectType & SystemsType & \multicolumn{3}{|l|}{See section \ref{type:SystemsType}} \\
HasSubtype & ObjectType & ElectricType & \multicolumn{3}{|l|}{See section \ref{type:ElectricType}} \\
HasSubtype & ObjectType & LinearType & \multicolumn{3}{|l|}{See section \ref{type:LinearType}} \\
...
HasComponent & Event & <MTCondition> & \multicolumn{2}{|l|}{MTConditionType[]} & Optional \\
HasCondition & Event & <MTCondition> & \multicolumn{2}{|l|}{MTConditionType[]} & Optional \\
HasComponent & Variable & <MTThreeSpaceSample> & \multicolumn{2}{|l|}{MTThreeSpaceSampleType[]} & Optional \\
...
HasMTClassType & Object & <MTDataItemClass> & \multicolumn{2}{|l|}{MTDataItemClassType} & Mandatory \\
...
HasMTSource & Object & <BaseObject> & \multicolumn{2}{|l|}{BaseObjectType} & Optional \\
HasCondition & Event & <MTCondition> & \multicolumn{2}{|l|}{MTConditionType} & Optional \\
HasComponent & Object & Constraints & \multicolumn{2}{|l|}{MTConstraintType} & Mandatory \\
\end{tabu}
\end{table} 
...
HasSubtype & ObjectType & ActuatorClassType & \multicolumn{3}{|l|}{See section \ref{type:ActuatorClassType}} \\
HasSubtype & ObjectType & CommunicationsClassType & \multicolumn{3}{|l|}{See section \ref{type:CommunicationsClassType}} \\
HasSubtype & ObjectType & DataRangeClassType & \multicolumn{3}{|l|}{See section \ref{type:DataRangeClassType}} \\
HasSubtype & ObjectType & LogicProgramClassType & \multicolumn{3}{|l|}{See section \ref{type:LogicProgramClassType}} \\
HasSubtype & ObjectType & HardwareClassType & \multicolumn{3}{|l|}{See section \ref{type:HardwareClassType}} \\
HasSubtype & ObjectType & MotionProgramClassType & \multicolumn{3}{|l|}{See section \ref{type:MotionProgramClassType}} \\
HasSubtype & ObjectType & SystemClassType & \multicolumn{3}{|l|}{See section \ref{type:SystemClassType}} \\
\end{tabu}
\end{table} 
...
HasSubtype & ObjectType & MTMessageClassType & \multicolumn{3}{|l|}{See section \ref{type:MTMessageClassType}} \\
\end{tabu}
\end{table} 
...
\tabucline[1.5pt]{}
\rowfont \bfseries References & NodeClass & BrowseName & DataType & TypeDefinition & {Modeling Rule} \\
\multicolumn{6}{|l|}{Subtype of \texttt{ConditionType} (See \cite{UAPart9} Documentation)} \\
HasProperty & Variable & XmlId & String & PropertyType & Mandatory \\
HasProperty & Variable & Name & String & PropertyType & Optional \\
HasProperty & Variable & Category & MTCategoryType & PropertyType & Mandatory \\
HasProperty & Variable & MTTypeName & String & PropertyType & Mandatory \\
...
HasComponent & Variable & ActiveState & \multicolumn{2}{|l|}{TwoStateVariableType} & Mandatory \\
\end{tabu}
\end{table} 
...
HasSubtype & ObjectType & PartChangeClassType & \multicolumn{3}{|l|}{See section \ref{type:PartChangeClassType}} \\
\multicolumn{6}{|l|}{Continued...} \\
\end{tabu}
\end{table}
\begin{table}[ht]
...
HasProperty & Variable & EnumValues & \multicolumn{2}{|l|}{ActiveStateDataType} & Mandatory \\
\end{tabu}
\end{table} 
...
\rowfont \bfseries References & NodeClass & BrowseName & DataType & TypeDefinition & {Modeling Rule} \\
\multicolumn{6}{|l|}{Subtype of \texttt{MTControlledVocabClassType} (See section \ref{type:MTControlledVocabClassType})} \\
HasProperty & Variable & EnumValues & \multicolumn{2}{|l|}{AvailabilityDataType} & Mandatory \\
\end{tabu}
\end{table} 
...
\rowfont \bfseries References & NodeClass & BrowseName & DataType & TypeDefinition & {Modeling Rule} \\
\multicolumn{6}{|l|}{Subtype of \texttt{MTControlledVocabClassType} (See section \ref{type:MTControlledVocabClassType})} \\
HasProperty & Variable & EnumValues & \multicolumn{2}{|l|}{AxisCouplingDataType} & Mandatory \\
\end{tabu}
\end{table} 
...
\rowfont \bfseries References & NodeClass & BrowseName & DataType & TypeDefinition & {Modeling Rule} \\
\multicolumn{6}{|l|}{Subtype of \texttt{MTControlledVocabClassType} (See section \ref{type:MTControlledVocabClassType})} \\
HasProperty & Variable & EnumValues & \multicolumn{2}{|l|}{AxisStateDataType} & Mandatory \\
\end{tabu}
\end{table} 
...
\rowfont \bfseries References & NodeClass & BrowseName & DataType & TypeDefinition & {Modeling Rule} \\
\multicolumn{6}{|l|}{Subtype of \texttt{MTControlledVocabClassType} (See section \ref{type:MTControlledVocabClassType})} \\
HasProperty & Variable & EnumValues & \multicolumn{2}{|l|}{OpenStateDataType} & Mandatory \\
\end{tabu}
\end{table} 
...
\rowfont \bfseries References & NodeClass & BrowseName & DataType & TypeDefinition & {Modeling Rule} \\
\multicolumn{6}{|l|}{Subtype of \texttt{MTControlledVocabClassType} (See section \ref{type:MTControlledVocabClassType})} \\
HasProperty & Variable & EnumValues & \multicolumn{2}{|l|}{ControllerModeDataType} & Mandatory \\
\end{tabu}
\end{table} 
...
\rowfont \bfseries References & NodeClass & BrowseName & DataType & TypeDefinition & {Modeling Rule} \\
\multicolumn{6}{|l|}{Subtype of \texttt{MTControlledVocabClassType} (See section \ref{type:MTControlledVocabClassType})} \\
HasProperty & Variable & EnumValues & \multicolumn{2}{|l|}{ExecutionDataType} & Mandatory \\
\end{tabu}
\end{table} 
...
\rowfont \bfseries References & NodeClass & BrowseName & DataType & TypeDefinition & {Modeling Rule} \\
\multicolumn{6}{|l|}{Subtype of \texttt{MTControlledVocabClassType} (See section \ref{type:MTControlledVocabClassType})} \\
HasProperty & Variable & EnumValues & \multicolumn{2}{|l|}{CompositionStateDataType} & Mandatory \\
\end{tabu}
\end{table} 
...
\rowfont \bfseries References & NodeClass & BrowseName & DataType & TypeDefinition & {Modeling Rule} \\
\multicolumn{6}{|l|}{Subtype of \texttt{MTControlledVocabClassType} (See section \ref{type:MTControlledVocabClassType})} \\
HasProperty & Variable & EnumValues & \multicolumn{2}{|l|}{OnOffDataType} & Mandatory \\
\end{tabu}
\end{table} 
...
\rowfont \bfseries References & NodeClass & BrowseName & DataType & TypeDefinition & {Modeling Rule} \\
\multicolumn{6}{|l|}{Subtype of \texttt{MTControlledVocabClassType} (See section \ref{type:MTControlledVocabClassType})} \\
HasProperty & Variable & EnumValues & \multicolumn{2}{|l|}{DirectionDataType} & Mandatory \\
\end{tabu}
\end{table} 
...
\rowfont \bfseries References & NodeClass & BrowseName & DataType & TypeDefinition & {Modeling Rule} \\
\multicolumn{6}{|l|}{Subtype of \texttt{MTControlledVocabClassType} (See section \ref{type:MTControlledVocabClassType})} \\
HasProperty & Variable & EnumValues & \multicolumn{2}{|l|}{EmergencyStopDataType} & Mandatory \\
\end{tabu}
\end{table} 
...
\rowfont \bfseries References & NodeClass & BrowseName & DataType & TypeDefinition & {Modeling Rule} \\
\multicolumn{6}{|l|}{Subtype of \texttt{MTControlledVocabClassType} (See section \ref{type:MTControlledVocabClassType})} \\
HasProperty & Variable & EnumValues & \multicolumn{2}{|l|}{YesNoDataType} & Mandatory \\
\end{tabu}
\end{table} 
...
\rowfont \bfseries References & NodeClass & BrowseName & DataType & TypeDefinition & {Modeling Rule} \\
\multicolumn{6}{|l|}{Subtype of \texttt{MTControlledVocabClassType} (See section \ref{type:MTControlledVocabClassType})} \\
HasProperty & Variable & EnumValues & \multicolumn{2}{|l|}{FunctionalModeDataType} & Mandatory \\
\end{tabu}
\end{table} 
...
\rowfont \bfseries References & NodeClass & BrowseName & DataType & TypeDefinition & {Modeling Rule} \\
\multicolumn{6}{|l|}{Subtype of \texttt{MTControlledVocabClassType} (See section \ref{type:MTControlledVocabClassType})} \\
HasProperty & Variable & EnumValues & \multicolumn{2}{|l|}{PathModeDataType} & Mandatory \\
\end{tabu}
\end{table} 
...
\rowfont \bfseries References & NodeClass & BrowseName & DataType & TypeDefinition & {Modeling Rule} \\
\multicolumn{6}{|l|}{Subtype of \texttt{MTControlledVocabClassType} (See section \ref{type:MTControlledVocabClassType})} \\
HasProperty & Variable & EnumValues & \multicolumn{2}{|l|}{ProgramEditDataType} & Mandatory \\
\end{tabu}
\end{table} 
...
\rowfont \bfseries References & NodeClass & BrowseName & DataType & TypeDefinition & {Modeling Rule} \\
\multicolumn{6}{|l|}{Subtype of \texttt{MTControlledVocabClassType} (See section \ref{type:MTControlledVocabClassType})} \\
HasProperty & Variable & EnumValues & \multicolumn{2}{|l|}{RotaryModeDataType} & Mandatory \\
\end{tabu}
\end{table} 
...
\rowfont \bfseries References & NodeClass & BrowseName & DataType & TypeDefinition & {Modeling Rule} \\
\multicolumn{6}{|l|}{Subtype of \texttt{MTControlledVocabClassType} (See section \ref{type:MTControlledVocabClassType})} \\
HasProperty & Variable & EnumValues & \multicolumn{2}{|l|}{InterfaceStatusDataType} & Mandatory \\
\end{tabu}
\end{table} 
...
\rowfont \bfseries References & NodeClass & BrowseName & DataType & TypeDefinition & {Modeling Rule} \\
\multicolumn{6}{|l|}{Subtype of \texttt{MTControlledVocabClassType} (See section \ref{type:MTControlledVocabClassType})} \\
HasProperty & Variable & EnumValues & \multicolumn{2}{|l|}{InterfaceStateDataType} & Mandatory \\
\end{tabu}
\end{table} 
...
\tabucline[1.5pt]{}
\rowfont \bfseries References & NodeClass & BrowseName & DataType & TypeDefinition & {Modeling Rule} \\
\multicolumn{6}{|l|}{Subtype of \texttt{MTConditionClassType} (See Data Items Documentation)} \\
\end{tabu}
\end{table} 
