% Generated 2018-11-08 10:41:52 -0800
...
\tabulinesep=3pt
\begin{tabu} to 6in {|X[-1.35]|X[-0.7]|X[-1.75]|X[-1.2]|X|X[-1]|} \everyrow{\hline}
\hline
...
Has\-Condition & Event & <MT\-Condition> & \multicolumn{2}{l|}{MTConditionType} & Optional \\
Has\-Component & Object & Constraints & \multicolumn{2}{l|}{MTConstraintType} & Mandatory \\
\end{tabu}
\end{table} 
...
\tabucline[1.5pt]{}
\rowfont \bfseries References & NodeClass & BrowseName & DataType & TypeDefinition & {Modeling\-Rule} \\
\multicolumn{6}{|l|}{Subtype of \texttt{NonHierarchicalReferences} (See \cite{UAPart5} Documentation)} \\
\end{tabu}
\end{table} 
