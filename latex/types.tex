% Generated 2018-11-19 17:25:35 -0800
...
The \mtmodel{MTCompositionType} is the abstract supertype of the dynamically generated
composition types based on the attribute \mtmodel{type} of the \gls{Composition} element
of the MTConnect \gls{MTComponent}. The \gls{Composition} is then related to the 
DataItems that reference the \gls{Composition}'s id in their \mtmodel{compositionId} 
attribute. 
