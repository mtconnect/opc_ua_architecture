% Generated 2018-10-01 18:08:34 -0700
...
\begin{itemize}
\item node_id -- \\ 
  Constraint: \indent \begin{Verbatim}[xleftmargin=.5in,fontsize=\small]
context Component::NodeId : String 
derive: concat(self.getDevice().uuid, self.getAttributes().id)
\end{Verbatim}
\hang Documentation: The NodeId SHALL be derrived from the combination of the device UUID and the id of the component. 
...
uuid->notEmpty()
\end{Verbatim}
\hang Documentation: The  UUID SHALL be provided.
...
name->notEmpty()
\end{Verbatim}
\hang Documentation: The name of the Device SHALL be given.
