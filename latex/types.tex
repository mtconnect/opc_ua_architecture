% Generated 2018-10-08 22:32:35 -0700
...
\tabucline[1.5pt]{}
\rowfont \bfseries References & NodeClass & BrowseName & DataType & TypeDefinition & {Modeling Rule} \\
\multicolumn{6}{|l|}{Subtype of FolderType (See OPC UA Part 5 Documentation)} \\
...
HasProperty & Variable & <Dynamic> &  MTDataItemSubType & <Dynamic> & Optional \\
HasProperty & Variable & <Dynamic> &  MinimumDeltaFilterType & <Dynamic> & Optional \\
HasProperty & Variable & <Dynamic> &  PeriodFilterType & <Dynamic> & Optional \\
HasProperty & Variable & <Dynamic> &  MTDataItemClassType & <Dynamic> & Mandatory \\
\end{tabu}
\end{table} 
...
Rate of change of velocity $\frac{mm}{s^{2}}$
...
The measurement of accumulated time for an activity or event. seconds
...
Rate of change of angular velocity.  $\frac{deg}{s^{2}}$
...
Rate of change of angular position. deg/s
...
The feedrate of a linear axis mm/s
...
The measurement of the amount of a substance remaining compared to the planned maximum amount of that substance. Reported in Percent.
...
The feedrate for the axes, or a single axis, associated with a Path component– a vector.
...
The measurement of reactive power in an AC electrical circuit (commonly referred to as VAR). $VOLT \times AMPERE (Reactive)$
...
The measurement of power flowing through or dissipated by an electrical circuit or piece of equipment. $WATT$
