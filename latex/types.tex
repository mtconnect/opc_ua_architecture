% Generated 2018-10-07 22:34:52 -0700
...
\FloatBarrier
\subsubsection{Defintion of \texttt{ MTConditionClassId}} \label{type:MTConditionClassId}
...
\begin{table}[ht]
\centering 
  \caption{\texttt{MTConditionClassId} Definition}
  \label{table:MTConditionClassId}
\fontsize{9pt}{11pt}\selectfont
\tabulinesep=3pt
\begin{tabu} to 6in {|l|l|l|l|l|l|} \everyrow{\hline}
\hline
\rowfont\bfseries {Attribute} & \multicolumn{5}{|l|}{Value} \\
\tabucline[1.5pt]{}
BrowseName & \multicolumn{5}{|l|}{MTConditionClassId} \\
IsAbstract & \multicolumn{5}{|l|}{False} \\
\tabucline[1.5pt]{}
\rowfont \bfseries References & NodeClass & BrowseName & DataType & TypeDefinition & {Modeling Rule} \\
...
HasSubtype & ObjectType & MTConditionClassId & \multicolumn{3}{|l|}{See section \ref{type:MTConditionClassId}} \\
\end{tabu}
\end{table} 
...
HasSubtype & ObjectType & AxisCouplingClassId & \multicolumn{3}{|l|}{See section \ref{type:AxisCouplingClassId}} \\
HasSubtype & ObjectType & AxisInterlockClassId & \multicolumn{3}{|l|}{See section \ref{type:AxisInterlockClassId}} \\
HasSubtype & ObjectType & AxisStateClassId & \multicolumn{3}{|l|}{See section \ref{type:AxisStateClassId}} \\
HasSubtype & ObjectType & ChuckInterlockClassId & \multicolumn{3}{|l|}{See section \ref{type:ChuckInterlockClassId}} \\
HasSubtype & ObjectType & ChuckStateClassId & \multicolumn{3}{|l|}{See section \ref{type:ChuckStateClassId}} \\
HasSubtype & ObjectType & ControllerModeClassId & \multicolumn{3}{|l|}{See section \ref{type:ControllerModeClassId}} \\
HasSubtype & ObjectType & ExecutionClassId & \multicolumn{3}{|l|}{See section \ref{type:ExecutionClassId}} \\
\end{tabu}
\end{table} 
