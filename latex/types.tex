% Generated 2018-10-25 19:34:27 -0700
...
Organizes & Object & Conditions & MTConditionType & FolderType & Optional \\
\end{tabu}
\end{table} 
...
The condition type is a derived from the UA \texttt{OffNormalAlarmType} that 
references the Normal state object. The object is an instance of the UA \texttt{InitialStateType}
and represents when the condition of a certain aspect of the component or the 
...
\tabucline[1.5pt]{}
\rowfont \bfseries References & NodeClass & BrowseName & DataType & TypeDefinition & {Modeling Rule} \\
\multicolumn{6}{|l|}{Subtype of \texttt{OffNormalAlarmType} (See \cite{UAPart9} Documentation)} \\
HasProperty & Variable & NativeCode & String & PropertyType & Optional \\
...
\paragraph{Dependency on Normal}

This class relates to \texttt{Normal} (See section \ref{type:Normal}) for a(n) \texttt{} relationship.
