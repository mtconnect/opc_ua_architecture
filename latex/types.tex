% Generated 2018-10-19 19:00:54 -0700
...
\paragraph{Dependency on MTControlledVocabEventType}

This class relates to \texttt{MTControlledVocabEventType} (See section \ref{type:MTControlledVocabEventType}) for a(n) \texttt{Instantiates} relationship.
