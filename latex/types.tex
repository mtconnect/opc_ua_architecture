% Generated 2018-10-31 23:59:44 -0700
...
HasCondition & Event & <MTCondition> & \multicolumn{2}{|l|}{MTConditionType} & Optional \\
HasProperty & Variable & Constraints & \multicolumn{2}{|l|}{ConstraintDataType} & Optional \\
\end{tabu}
\end{table} 
...
\paragraph{Dependencies and Relationships}
\begin{itemize}
\item Dependency on MTDataItemType
...
\mtterm{MTConnectStreams} document. The state will also correspond to the OPC UA Severity
