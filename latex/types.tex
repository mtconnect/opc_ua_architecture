% Generated 2018-11-11 16:38:40 -0800
...
\FloatBarrier
\subsubsection{Defintion of \texttt{ BaseAnalogType}}
  \label{type:BaseAnalogType}

\FloatBarrier

This type is part of OPC UA Amendment 1 \cite{UAAmend1} to Part 8 \cite{UAPart8}. Once it is available
in the OPC UA Nodeset, it will be removed. It is placed here to generate the MTConnect Nodeset
correctly.

\begin{table}[ht]
\centering 
  \caption{\texttt{BaseAnalogType} Definition}
  \label{table:BaseAnalogType}
\fontsize{9pt}{11pt}\selectfont
\tabulinesep=3pt
\begin{tabu} to 6in {|X[-1.35]|X[-0.7]|X[-1.75]|X[-1.5]|X[-1]|X[-0.7]|} \everyrow{\hline}
\hline
\rowfont\bfseries {Attribute} & \multicolumn{5}{|l|}{Value} \\
\tabucline[1.5pt]{}
BrowseName & \multicolumn{5}{|l|}{BaseAnalogType} \\
IsAbstract & \multicolumn{5}{|l|}{False} \\
...
HasSubtype & VariableType & \multicolumn{2}{l}{AnalogItemType} & \multicolumn{2}{|l|}{See section \ref{type:AnalogItemType}} \\
HasSubtype & VariableType & \multicolumn{2}{l}{AnalogUnitType} & \multicolumn{2}{|l|}{See section \ref{type:AnalogUnitType}} \\
Has\-Property & Variable & Instrument\-Range & Range & Property\-Type & Optional \\
...
\FloatBarrier
\subsubsection{Defintion of \texttt{ AnalogUnitType}}
  \label{type:AnalogUnitType}
...
\begin{table}[ht]
\centering 
  \caption{\texttt{AnalogUnitType} Definition}
  \label{table:AnalogUnitType}
\fontsize{9pt}{11pt}\selectfont
\tabulinesep=3pt
\begin{tabu} to 6in {|X[-1.35]|X[-0.7]|X[-1.75]|X[-1.5]|X[-1]|X[-0.7]|} \everyrow{\hline}
\hline
\rowfont\bfseries {Attribute} & \multicolumn{5}{|l|}{Value} \\
\tabucline[1.5pt]{}
BrowseName & \multicolumn{5}{|l|}{AnalogUnitType} \\
IsAbstract & \multicolumn{5}{|l|}{False} \\
ValueRank & \multicolumn{5}{|l|}{-2} \\
DataType & \multicolumn{5}{|l|}{Number} \\
\tabucline[1.5pt]{}
\rowfont \bfseries References & NodeClass & BrowseName & DataType & Type\-Definition & {Modeling\-Rule} \\
\multicolumn{6}{|l|}{Subtype of BaseAnalogType (See section \ref{type:BaseAnalogType})} \\
HasSubtype & VariableType & \multicolumn{2}{l}{MTSampleType} & \multicolumn{2}{|l|}{See section \ref{type:MTSampleType}} \\
...
floating point numeric data and comply with the \uaterm{AnalogUnitType} from \cite{UAPart8} Amendment 1.
In ammendment 1, the \uaterm{EURange} is optional. \uaterm{EngineeringUnits} for all \mtuatype{MTSampleType} Data Items.

The \uaterm{EURange} will becreated if the \xmlelement{Constraints} element exists and both \mtterm{Maximum} 
and \mtterm{Minimum} values are given. 
...
\tabucline[1.5pt]{}
\rowfont \bfseries References & NodeClass & BrowseName & DataType & Type\-Definition & {Modeling\-Rule} \\
\multicolumn{6}{|l|}{Subtype of AnalogUnitType (See section \ref{type:AnalogUnitType})} \\
Has\-Property & Variable & Xml\-Id & String & Property\-Type & Mandatory \\
Has\-Property & Variable & Name & String & Property\-Type & Optional \\
